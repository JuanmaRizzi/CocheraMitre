...
public class ReservasView extends JFrame {
	...
	public ReservasView() {
		...
		txtValor.setFont(new Font("Roboto Black", Font.BOLD, 13));
		...
		txtFormaPago.setModel(new DefaultComboBoxModel(
				new String[] { "Transferencia", "Dinero en efectivo" }));
	...
	public void calcularValor(JDateChooser dataE, JDateChooser dataS) {
		if(dataE.getDate() != null && dataS.getDate() != null) {
			if(dataE.getDate().after(dataS.getDate())) {
				JOptionPane.showMessageDialog(null, "La fecha de entrada no puede ser posterior a la de salida", "error en fechas", JOptionPane.ERROR_MESSAGE);
